...
# ----------------------------
def main():
    parser = argparse.ArgumentParser(description="Fine-tune swin-t on custom dataset")
    parser.add_argument("--data_dir", type=str, default="dataset", help="Root dataset dir containing train/val/test")
    parser.add_argument("--out_dir", type=str, default="outputs/swin_t", help="Directory to save checkpoints and metrics")
